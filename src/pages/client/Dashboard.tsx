      ...
      <header className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pt-3">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center space-x-2 bg-white dark:bg-slate-800 px-3 py-1.5 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
            ...
            <span className="text-xs font-semibold text-slate-500 dark:text-slate-400">Competência:</span>
            <select 
              value={selectedCompetence}
              onChange={e => setSelectedCompetence(e.target.value)}
              className="border-0 bg-transparent text-sm font-black text-slate-800 dark:text-white outline-none focus:ring-0 cursor-pointer"
            >
